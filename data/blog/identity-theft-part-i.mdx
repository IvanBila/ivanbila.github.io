...
tags: ['security']
draft: false
summary: "Sharing photos of people's documents online might sound beneign, but this might turn out to be disastrous, here we will explore how a thread-actor might use OSINT to exploit users"
layout: PostSimple
---
